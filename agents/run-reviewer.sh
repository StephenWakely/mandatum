...
# Usage: ./run-reviewer.sh [agent-id]

set -euo pipefail

AGENT_ID="${1:-reviewer-$(hostname)-$$}"
...
4. Call setup_worktree with worktree_path \".worktrees/\${branch_name}-review\" — run the returned commands
