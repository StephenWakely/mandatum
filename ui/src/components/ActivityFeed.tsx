...
import { ActivityEntry, AgentRole } from '../types'
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        ...
        {(entries as ActivityEntry[]).map(entry => (
          <div key={entry.id} className="bg-slate-800 rounded-lg p-2.5 space-y-1">
            ...
            <p className="text-xs text-slate-400">
              <span className="font-medium text-slate-300">{entry.action.replace(/_/g, ' ')}</span>
